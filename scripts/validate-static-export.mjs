...
const pages = {
  home: {
    ...
    required: [
      ...
      '/images/app/create-menu.jpg',
      '/images/app/discover-groups.jpg',
      '/images/app/discover-meetings.jpg',
      '/images/app/profile-settings.jpg',
    ...
    forbiddenPatterns: [
      ...
      /\/images\/app\/(?:create-menu|discover-groups|discover-meetings|profile-settings)\.png/,
      /exports\/final/,
    ],
    routeMetadata: false,
    language: 'en',
